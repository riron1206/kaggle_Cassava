...
# 追加メンバー1,2_v2
# resnest101e_tta.pkl
# tf_efficientnet_b4_ns_fold3_tta.pkl
# vit_b16_224_fold10_tta
# 22019613のTTAをなくす + weightedで ex09加える
# 22019632のTTAなくす
# 22019717 + ex08C を加える
...
"""
追加メンバー1
blend_22019613_w380_and_ex09C_w620_efficientnet-b4.pkl
22019613 * 0.380 + ex09C * 0.620 -> oof = 0.90209
"""
add_dir = r"C:\Users\81908\jupyter_notebook\pytorch_lightning_work\kaggle_Cassava\kaggle_datasets_dl\cassavapkl_v35"
pkl = f"{add_dir}/blend_22019613_w380_and_ex09C_w620_efficientnet-b4.pkl"
pred = pickle.load(open(pkl, "rb"))
preds.append(pred.values)

"""
追加メンバー2
blend_22019717_w412_and_ex08C_w588_timm-resnest101e.pkl
22019717 * 0.412 + ex08C * 0.588 -> oof = 0.90232
"""
add_dir = r"C:\Users\81908\jupyter_notebook\pytorch_lightning_work\kaggle_Cassava\kaggle_datasets_dl\cassavapkl_v35"
pkl = f"{add_dir}/blend_22019717_w412_and_ex08C_w588_timm-resnest101e.pkl"
pred = pickle.load(open(pkl, "rb"))
preds.append(pred.values)
